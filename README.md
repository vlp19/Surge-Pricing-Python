...
#### This project analyzes and predicts rideshare fare volatility in the New York City metropolitan area

Using a dataset of over 1 million trips, I developed a gradient-boosted regression model (LightGBM), as well as linear regression models, to estimate fares and utilized SHAP to deconstruct what goes on behind the scenes of surge pricing
...
2. *Inelastic Demand Windows*: Identifying windows for commuters to optimize margins without significant volume loss.
